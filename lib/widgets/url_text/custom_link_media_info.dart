...
import 'package:batterymonitor/navigator/utility.dart';
import 'package:batterymonitor/models/link_media_info.dart';
...
class CustomLinkMediaInfo extends StatelessWidget {
  const CustomLinkMediaInfo({super.key, this.url, this.text});
  final String? url;
  final String? text;
  String? getUrl() {
    if (text == null) {
